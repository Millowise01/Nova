...
>
> **Real specification:** [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md) — PaymentIntent state machine
...
criteria for **Payment Flow**. It is part of Nova's professional
