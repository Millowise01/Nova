...
>
> **Real specification:** [backend/docs/08-security-implementation-checklist.md](../../backend/docs/08-security-implementation-checklist.md) — §2.3 PCI scope; [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md)
...
criteria for **Payment Security**. It is part of Nova's professional
