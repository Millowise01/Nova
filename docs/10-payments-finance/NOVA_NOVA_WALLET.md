...
>
> **Real specification:** [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md) — Wallet
...
criteria for **Nova Wallet**. It is part of Nova's professional
