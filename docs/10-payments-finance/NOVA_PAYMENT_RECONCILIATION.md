...
>
> Not built: the payment provider is a stub and no reconciliation exists. The provider is undecided.
>
...
criteria for **Payment Reconciliation**. It is part of Nova's
