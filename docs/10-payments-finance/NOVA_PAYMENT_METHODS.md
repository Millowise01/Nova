...
>
> **Real specification:** [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md) — payment methods
...
criteria for **Payment Methods**. It is part of Nova's professional
