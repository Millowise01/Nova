...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — Finance, SellerPayout
...
criteria for **Seller Payouts**. It is part of Nova's professional
