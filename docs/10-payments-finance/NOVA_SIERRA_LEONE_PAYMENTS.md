...
>
> The production payment provider has not been chosen.
>
> **Real specification:** [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md) — PSP integration is stubbed
...
criteria for **Sierra Leone Payments**. It is part of Nova's
