...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — Finance ledger
...
criteria for **Transaction Ledger**. It is part of Nova's professional
