...
| `@nova/validation`                      | 802    | 56 / 10                                           | ACTIVE      | Zod schemas shared by frontend and backend. One file, plus a compiled CommonJS build for the backend (ADR-0004).                                                             |
| `@nova/api-client`                      | 804    | 23 / 0                                            | ACTIVE      |                                                                                                                                                                              |
| `@nova/app-shell`                       | 532    | 23 / 0                                            | ACTIVE      | Providers, authentication and the role guard (`@nova/app-shell/middleware`), parameterized per app (ADR-0002).                                                               |
