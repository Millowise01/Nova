...
| `@nova/app-shell`                       | 188    | 9 / 0                                             | ACTIVE      | Shared providers (theme, toast, query client) parameterized per app; authentication follows (ADR-0002, Phase 5 item C). Depends on `@nova/ui`.                               |
