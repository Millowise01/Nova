...
>
> **Real specification:** [.claude/CLAUDE.md](../../.claude/CLAUDE.md) — Quality gates and Definition of done
...
criteria for **Definition Of Done**. It is part of Nova's professional
