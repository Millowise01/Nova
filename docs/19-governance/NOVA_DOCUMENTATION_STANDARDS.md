...
>
> The stub-notice convention is described in docs/README.md.
>
> **Real specification:** [docs/README.md](../../docs/README.md)
...
criteria for **Documentation Standards**. It is part of Nova's
