...
>
> **Real specification:** [backend/docs/08-security-implementation-checklist.md](../../backend/docs/08-security-implementation-checklist.md) — §4 API Security
...
criteria for **Api Security**. It is part of Nova's professional
