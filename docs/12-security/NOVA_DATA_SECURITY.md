...
>
> **Real specification:** [backend/docs/08-security-implementation-checklist.md](../../backend/docs/08-security-implementation-checklist.md) — §2 Data Protection
...
criteria for **Data Security**. It is part of Nova's professional
