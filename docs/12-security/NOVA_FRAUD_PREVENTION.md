...
>
> Fraud scoring, velocity checks and the human review queue are explicitly deferred.
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — Trust & Safety
...
criteria for **Fraud Prevention**. It is part of Nova's professional
