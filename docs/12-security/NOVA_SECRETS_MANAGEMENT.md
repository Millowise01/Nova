...
>
> **Real specification:** [backend/docs/05-security-baseline.md](../../backend/docs/05-security-baseline.md) — secrets handling
>
> **Implementation reference (code, not a specification):** [.secretlintrc.json](../../.secretlintrc.json)
...
criteria for **Secrets Management**. It is part of Nova's professional
