...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md) — rate limiting and abuse controls; [backend/docs/08-security-implementation-checklist.md](../../backend/docs/08-security-implementation-checklist.md) — §4.1
...
criteria for **Rate Limiting**. It is part of Nova's professional
