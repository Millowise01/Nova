...
>
> **Real specification:** [backend/docs/05-security-baseline.md](../../backend/docs/05-security-baseline.md) — RBAC and ABAC; [backend/docs/08-security-implementation-checklist.md](../../backend/docs/08-security-implementation-checklist.md) — §1.2–1.3
...
criteria for **Authorization**. It is part of Nova's professional
