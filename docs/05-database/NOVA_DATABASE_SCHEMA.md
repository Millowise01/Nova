...
>
> **Real specification:** [backend/docs/03-database-conventions.md](../../backend/docs/03-database-conventions.md)
>
...
criteria for **Database Schema**. It is part of Nova's professional
