...
>
> **Real specification:** [backend/docs/03-database-conventions.md](../../backend/docs/03-database-conventions.md); [backend/docs/07-glossary.md](../../backend/docs/07-glossary.md) — ubiquitous language
>
...
criteria for **Data Model**. It is part of Nova's professional
