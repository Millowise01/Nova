...
>
> **Real specification:** [backend/docs/03-database-conventions.md](../../backend/docs/03-database-conventions.md) — migration policy
>
> **Implementation reference (code, not a specification):** [backend/prisma/migrations](../../backend/prisma/migrations)
...
criteria for **Database Migrations**. It is part of Nova's professional
