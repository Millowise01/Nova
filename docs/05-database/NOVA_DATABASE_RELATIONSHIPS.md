...
>
> **Real specification:** [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md); [backend/docs/01-module-contract.md](../../backend/docs/01-module-contract.md) — cross-module references
>
> **Implementation reference (code, not a specification):** [backend/prisma/schema.prisma](../../backend/prisma/schema.prisma) — the data model as built
...
criteria for **Database Relationships**. It is part of Nova's
