...
>
> **Real specification:** [backend/docs/03-database-conventions.md](../../backend/docs/03-database-conventions.md) — soft delete vs. hard delete only; no retention policy is defined
...
criteria for **Data Retention**. It is part of Nova's professional
