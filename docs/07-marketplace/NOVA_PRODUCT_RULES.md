...
>
> **Real specification:** [backend/docs/07-glossary.md](../../backend/docs/07-glossary.md) — Product, Variant, SKU, Category
...
criteria for **Product Rules**. It is part of Nova's professional
