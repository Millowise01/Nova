...
>
> **Real specification:** [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md) — Orders; [backend/docs/07-glossary.md](../../backend/docs/07-glossary.md) — Order, Order State, Sub-Order
...
criteria for **Order Rules**. It is part of Nova's professional
