...
>
> **Real specification:** [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md) — Refunds
...
criteria for **Refund Rules**. It is part of Nova's professional
