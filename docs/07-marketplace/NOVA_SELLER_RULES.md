...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — KYC and seller suspension; [backend/docs/07-glossary.md](../../backend/docs/07-glossary.md) — Marketplace Seller / Retail Partner

**Phase:** `07-marketplace`\
**Status:** Stub — not source of truth\
...
criteria for **Seller Rules**. It is part of Nova's professional
