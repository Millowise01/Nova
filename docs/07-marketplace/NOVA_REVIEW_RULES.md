...
>
> **Real specification:** [backend/docs/07-glossary.md](../../backend/docs/07-glossary.md) — Review definition only
...
criteria for **Review Rules**. It is part of Nova's professional
