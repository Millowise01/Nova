...
>
> **Implementation reference (code, not a specification):** [.github/workflows/e2e.yml](../../.github/workflows/e2e.yml); [apps/web/e2e](../../apps/web/e2e); [apps/seller/e2e](../../apps/seller/e2e)
...
criteria for **E2E Testing**. It is part of Nova's professional
