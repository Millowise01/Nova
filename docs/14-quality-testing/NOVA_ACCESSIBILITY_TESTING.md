...
>
> **Real specification:** [docs/frontend/06-accessibility-and-performance.md](../frontend/06-accessibility-and-performance.md)
...
criteria for **Accessibility Testing**. It is part of Nova's
