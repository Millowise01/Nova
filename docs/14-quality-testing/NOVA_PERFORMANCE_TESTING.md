...
>
> **Real specification:** [docs/frontend/06-accessibility-and-performance.md](../frontend/06-accessibility-and-performance.md) — performance budget
...
criteria for **Performance Testing**. It is part of Nova's professional
