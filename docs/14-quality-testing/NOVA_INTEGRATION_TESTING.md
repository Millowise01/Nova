...
>
> **Real specification:** [backend/docs/06-testing-strategy.md](../../backend/docs/06-testing-strategy.md)
...
criteria for **Integration Testing**. It is part of Nova's professional
