...
>
> **Real specification:** [backend/docs/05-security-baseline.md](../../backend/docs/05-security-baseline.md)
...
criteria for **Api Authentication**. It is part of Nova's professional
