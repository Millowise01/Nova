...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md) — URL structure and versioning
...
criteria for **Api Versioning**. It is part of Nova's professional
