...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md) — error response shape
...
criteria for **Api Errors**. It is part of Nova's professional
