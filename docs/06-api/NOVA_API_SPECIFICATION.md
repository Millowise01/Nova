...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md)
>
> **Implementation reference (code, not a specification):** [backend/openapi.json](../../backend/openapi.json) — generated API contract
...
criteria for **Api Specification**. It is part of Nova's professional
