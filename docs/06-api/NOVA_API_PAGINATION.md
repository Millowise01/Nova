...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md) — pagination
...
criteria for **Api Pagination**. It is part of Nova's professional
