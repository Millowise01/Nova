...
>
> No product or business specification exists in the repository. The Nova Enterprise Blueprint (Vol 1) is kept outside the repository.
>
> **Real specification:** none exists in the repository yet.

**Phase:** `01-product-business`\
**Status:** Stub — not source of truth\
...
criteria for **Marketplace Model**. It is part of Nova's professional
