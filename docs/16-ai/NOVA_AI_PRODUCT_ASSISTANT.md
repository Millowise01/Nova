...
>
> The AI platform is a deferred context (Phase 3+).
>
> **Real specification:** [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md) — Phase 3+ AI Platform
...
criteria for **Ai Product Assistant**. It is part of Nova's professional
