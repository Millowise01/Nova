...
>
> **Real specification:** [backend/docs/05-security-baseline.md](../../backend/docs/05-security-baseline.md) — RBAC and ABAC
...
criteria for **Admin Permissions**. It is part of Nova's professional
