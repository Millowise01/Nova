...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — Trust & Safety and admin review queue endpoints
...
criteria for **Dispute Management**. It is part of Nova's professional
