...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §34 Admin Interface; [docs/frontend/00-app-map.md](../frontend/00-app-map.md)
...
criteria for **Admin Platform**. It is part of Nova's professional
