...
>
> **Real specification:** [backend/docs/05-security-baseline.md](../../backend/docs/05-security-baseline.md) — audit logging
...
criteria for **Audit Logs**. It is part of Nova's professional
