...
>
> The commission rate is an open business decision; no rate or fee schedule is specified anywhere.
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — Finance scope boundary
...
criteria for **Seller Commission**. It is part of Nova's professional
