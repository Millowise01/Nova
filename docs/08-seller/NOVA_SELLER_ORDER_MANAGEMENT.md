...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — logged seller-portal gaps, including the missing seller order queue
...
criteria for **Seller Order Management**. It is part of Nova's
