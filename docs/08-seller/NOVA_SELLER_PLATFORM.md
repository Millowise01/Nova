...
>
> **Real specification:** [docs/frontend/00-app-map.md](../frontend/00-app-map.md); [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — logged seller-portal gaps
...
criteria for **Seller Platform**. It is part of Nova's professional
