...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — KYC
...
criteria for **Seller Onboarding**. It is part of Nova's professional
