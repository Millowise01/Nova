# Nova --- Seller Product Management
...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §32 Seller Product Management
...
criteria for **Seller Product Management**. It is part of Nova's
