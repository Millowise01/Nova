...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §31 Seller Dashboard; [docs/frontend/00-app-map.md](../frontend/00-app-map.md)
...
criteria for **Seller Dashboard**. It is part of Nova's professional
