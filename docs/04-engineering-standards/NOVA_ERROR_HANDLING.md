...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md) — error response shape; [backend/docs/08-security-implementation-checklist.md](../../backend/docs/08-security-implementation-checklist.md) — §3.4 no stack traces in error responses; [docs/frontend/01-data-fetching-conventions.md](../frontend/01-data-fetching-conventions.md) — loading, error and empty states
...
criteria for **Error Handling**. It is part of Nova's professional
source-of-truth documentation system.
