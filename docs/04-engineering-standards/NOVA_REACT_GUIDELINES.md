...
>
> **Real specification:** [docs/frontend/04-state-management.md](../frontend/04-state-management.md); [docs/frontend/05-design-system-usage.md](../frontend/05-design-system-usage.md)
...
criteria for **React Guidelines**. It is part of Nova's professional
