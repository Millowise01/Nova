...
>
> **Real specification:** [.claude/CLAUDE.md](../../.claude/CLAUDE.md) — engineering principles; [CONTRIBUTING.md](../../CONTRIBUTING.md)
>
> **Implementation reference (code, not a specification):** [packages/eslint-config](../../packages/eslint-config); [prettier.config.mjs](../../prettier.config.mjs)
...
criteria for **Coding Standards**. It is part of Nova's professional
