# Nova --- Api Development Guidelines
...
>
> **Real specification:** [backend/docs/02-api-standards.md](../../backend/docs/02-api-standards.md); [backend/docs/01-module-contract.md](../../backend/docs/01-module-contract.md)
...
criteria for **Api Development Guidelines**. It is part of Nova's
