...
>
> No branching strategy has been decided.
>
> **Real specification:** [CONTRIBUTING.md](../../CONTRIBUTING.md) — commit and pull request conventions; [.claude/CLAUDE.md](../../.claude/CLAUDE.md) — Git rules
...
criteria for **Branching Strategy**. It is part of Nova's professional
