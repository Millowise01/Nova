...
>
> **Real specification:** [CONTRIBUTING.md](../../CONTRIBUTING.md) — pull request checklist
>
> **Implementation reference (code, not a specification):** [.github/PULL_REQUEST_TEMPLATE.md](../../.github/PULL_REQUEST_TEMPLATE.md)
...
criteria for **Code Review Guidelines**. It is part of Nova's
