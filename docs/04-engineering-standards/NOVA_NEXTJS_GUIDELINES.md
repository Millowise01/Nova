...
>
> **Real specification:** [docs/frontend/03-routing-and-app-structure.md](../frontend/03-routing-and-app-structure.md)
...
criteria for **Nextjs Guidelines**. It is part of Nova's professional
