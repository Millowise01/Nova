...
>
> **Implementation reference (code, not a specification):** [.github/workflows/ci.yml](../../.github/workflows/ci.yml); [.github/workflows/e2e.yml](../../.github/workflows/e2e.yml)
...
criteria for **Ci Cd**. It is part of Nova's professional
