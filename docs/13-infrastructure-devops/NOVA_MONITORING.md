...
>
> **Real specification:** [backend/docs/05-security-baseline.md](../../backend/docs/05-security-baseline.md) — metrics endpoint
...
criteria for **Monitoring**. It is part of Nova's professional
