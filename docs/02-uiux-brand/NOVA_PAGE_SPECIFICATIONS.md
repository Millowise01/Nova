...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §16–43 screen-level rules; [docs/frontend/00-app-map.md](../frontend/00-app-map.md)
...
criteria for **Page Specifications**. It is part of Nova's professional
