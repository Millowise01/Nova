...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §55–56 Figma structure and component rules
...
criteria for **Figma Guidelines**. It is part of Nova's professional
