...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §14–43 components, §52–53 component architecture and rules, §74 component library; [docs/frontend/05-design-system-usage.md](../frontend/05-design-system-usage.md)
...
criteria for **Component Specification**. It is part of Nova's
