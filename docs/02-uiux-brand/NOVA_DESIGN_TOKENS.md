...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §4–10 tokens, color, typography, spacing, radius, shadows
>
> **Implementation reference (code, not a specification):** [packages/design-system](../../packages/design-system) — token implementation
...
criteria for **Design Tokens**. It is part of Nova's professional
