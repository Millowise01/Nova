...
>
> **Real specification:** [NOVA_UI_UX_DESIGN_SYSTEM.md](../02-uiux-brand/NOVA_UI_UX_DESIGN_SYSTEM.md) — §51 Accessibility; [docs/frontend/06-accessibility-and-performance.md](../frontend/06-accessibility-and-performance.md)
...
criteria for **Accessibility Guidelines**. It is part of Nova's
