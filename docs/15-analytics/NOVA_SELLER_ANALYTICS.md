...
>
> Analytics is a deferred context (Phase 3+).
>
> **Real specification:** [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md) — Phase 3+ Analytics
...
criteria for **Seller Analytics**. It is part of Nova's professional
