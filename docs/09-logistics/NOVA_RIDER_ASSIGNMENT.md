...
>
> **Real specification:** [backend/docs/10-logistics-finance-trust-safety-design.md](../../backend/docs/10-logistics-finance-trust-safety-design.md) — assignment is explicit and admin-only; no dispatch algorithm exists
...
criteria for **Rider Assignment**. It is part of Nova's professional
