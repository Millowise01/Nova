...
>
> **Real specification:** [README.md](../../README.md) — workspace layout and task graph
>
> **Implementation reference (code, not a specification):** [turbo.json](../../turbo.json); [pnpm-workspace.yaml](../../pnpm-workspace.yaml)
...
criteria for **Monorepo Architecture**. It is part of Nova's
