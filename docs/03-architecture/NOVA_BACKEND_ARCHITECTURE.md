...
>
> **Real specification:** [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md); [backend/docs/01-module-contract.md](../../backend/docs/01-module-contract.md); [backend/docs/04-events-and-jobs.md](../../backend/docs/04-events-and-jobs.md)
...
criteria for **Backend Architecture**. It is part of Nova's professional
