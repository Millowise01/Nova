...
>
> **Real specification:** [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md); [backend/docs/04-events-and-jobs.md](../../backend/docs/04-events-and-jobs.md); [docs/frontend/00-app-map.md](../frontend/00-app-map.md)
...
criteria for **System Architecture**. It is part of Nova's professional
