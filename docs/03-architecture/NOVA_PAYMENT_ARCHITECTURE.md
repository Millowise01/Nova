...
>
> **Real specification:** [backend/docs/09-payments-wallet-design.md](../../backend/docs/09-payments-wallet-design.md)
...
criteria for **Payment Architecture**. It is part of Nova's professional
