# Nova --- Notification Architecture
...
>
> **Real specification:** [backend/docs/04-events-and-jobs.md](../../backend/docs/04-events-and-jobs.md) — events and background jobs; [backend/docs/00-bounded-contexts.md](../../backend/docs/00-bounded-contexts.md) — notification ownership is flagged there as an open question
...
criteria for **Notification Architecture**. It is part of Nova's
