...
>
> **Real specification:** [docs/frontend/00-app-map.md](../frontend/00-app-map.md); [docs/frontend/03-routing-and-app-structure.md](../frontend/03-routing-and-app-structure.md); [docs/frontend/04-state-management.md](../frontend/04-state-management.md)
...
criteria for **Frontend Architecture**. It is part of Nova's
