 ...
 *  on every subsequent request. Identical to apps/web's version — small enough that
 *  duplicating it beats introducing a cross-app shared module for one function. */
