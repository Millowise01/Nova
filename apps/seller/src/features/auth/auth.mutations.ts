...
/** Same error-mapping convention as apps/web's and apps/admin's auth.mutations.ts. */
 ...
 *  gets a real session and is redirected like anyone else; middleware.ts catches
 *  the very next request and bounces them to /forbidden. Same reasoning as
 *  apps/admin's useLoginMutation. */
