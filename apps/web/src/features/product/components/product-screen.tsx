...
const productModules = [
  {
    title: "Image Gallery & Zoom",
    description: "Responsive media gallery with zoom interactions.",
  },
  {
    title: "Variants & Inventory",
    description: "Selection logic for options, stock, and availability.",
  },
...
export function ProductScreen() {
  return (
    <ModuleShell
      subtitle="Product detail surface for discovery, trust, and conversion."
