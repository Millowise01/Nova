...
export function HomeScreen() {
  ...
  return (
    <div className="space-y-8 pb-12 md:space-y-10 lg:space-y-12">
      ...
      <ProductSection
        description="High trust products picked by Nova's curation engine."
        products={featured}
        title="Featured Products"
      />
      <ProductSection
        description="What customers across Freetown are buying right now."
        products={trending}
        title="Trending Products"
      />
      <ProductSection
        description="Best performing items from verified sellers."
