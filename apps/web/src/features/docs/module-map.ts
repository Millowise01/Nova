...
export const moduleMap: Record<string, ModuleCard[]> = {
  auth: [
    ...
    { title: "OTP Verification", description: "2-step confirmation flow for account protection." },
    {
      ...
      description: "Recovery with expiring reset links and status feedback.",
    },
  ...
  catalog: [
    {
      ...
      description: "Primary catalog navigation and merchandising blocks.",
    },
    { title: "Brand Pages", description: "Brand storefront listings and campaign tie-ins." },
    {
      title: "Filter Drawer",
      description: "Attribute filters, multi-select facets, and quick clear.",
    },
    {
      title: "Sort and Pagination",
      description: "Grid/list sorters and infinite-scroll fallback.",
    },
  ],
  product: [
    {
      title: "Image Gallery",
      description: "High resolution product media with responsive variants.",
    },
    ...
    { title: "Reviews and Questions", description: "Community feedback, rating, and Q&A modules." },
    {
      ...
      description: "Store trust signals, policies, and shipping details.",
    },
  ],
  search: [
  ...
  checkout: [
    ...
    { title: "Payment Step", description: "Wallet, card placeholders, and payment intents." },
    {
      ...
      description: "Final totals, taxes, and confirmation detail.",
    },
  ],
  dashboard: [
  ...
  settings: [
    ...
    { title: "Privacy & Security", description: "Session, devices, and access controls." },
    {
      ...
      description: "Localization and commerce preference management.",
    },
  ],
};
